...
function resolvedFirebaseConfig() {
  ...
  return {
    apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || d.apiKey,
    authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || d.authDomain,
    projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || d.projectId,
    storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || d.storageBucket,
    messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || d.messagingSenderId,
    appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || d.appId,
    measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || d.measurementId,
  };
}
